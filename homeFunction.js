const datas = [
    {
        ...
        "explicao": "A palavra significa literalmente: Fazer ficar mais negro; tornar escuro. Em sentido FIGURADO, significa Manchar a reputação",
        "sugesto": "Difamar ",
        "categoria": "Racial"
    },
    {
...
function match() {
    ...
    if (indice < 44) {
        document.getElementById("outputText").innerHTML = "Não use: " + '"' + datas[indice].termoPalavra + '", ' + datas[indice].explicao +'</br>' +' Use "' + datas[indice].sugesto +'" no lugar.';
    }
    else {
